				  ...
				  <div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
					  ...
					  <li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li role="presentation"><a role="menuitem" tabindex="-1" href="dados_empresa_per.php">Período</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Contato</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Endereço de entrega</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1" href="#">Usuários</a></li>
